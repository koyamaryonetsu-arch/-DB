// ゲーム ぜんたいの しんこう
import { Input } from './input.js?v=cb6fd0fb30e1';
import { GameAudio } from './audio.js?v=cb6fd0fb30e1';
import { Field } from './field.js?v=cb6fd0fb30e1';
import { Hud, STAMPS } from './ui/hud.js?v=cb6fd0fb30e1';
import { FieldMenu, openWorldMap } from './ui/menu.js?v=cb6fd0fb30e1';
import { ScriptPlayer, wait } from './ui/script.js?v=cb6fd0fb30e1';
import { BattleScene } from './battle.js?v=cb6fd0fb30e1';
import { showTitle, showLogin, showSelect, showCreate, showLoading, saveWhere } from './ui/title.js?v=cb6fd0fb30e1';
import { toast, confirmBox, el } from './ui/dom.js?v=cb6fd0fb30e1';
import { MAPS } from '../shared/maps/index.js?v=cb6fd0fb30e1';
...
export class Game {
  ...
  onEnter(m) {
    ...
    if (this.net.mode === 'offline' && !this.saveWarned) {
      ...
      import('./offline.js?v=cb6fd0fb30e1').then(({ offlineStorage }) => {
        offlineStorage.load();
